...
const plans = [
  { name: "Plano 1", channels: 1, users: 5, price: "R$ 150", featured: false },
  { name: "Plano 2", channels: 2, users: 7, price: "R$ 250", featured: true },
  { name: "Plano 3", channels: 3, users: 9, price: "R$ 300", featured: false },
  { name: "Plano 4", channels: 4, users: 11, price: "R$ 350", featured: false },
  { name: "Plano 5", channels: 5, users: 15, price: "R$ 420", featured: false },
];
...
const clientLogos = [
  { name: "CrossHard", src: "/clientes/crosshard.png", width: "150px" },
  { name: "NutriTruck", src: "/clientes/nutritruck.png", width: "150px" },
  { name: "Eservice", src: "/clientes/eservice.png", width: "150px" },
  { name: "Evidence", src: "/clientes/evidence.png", width: "150px" },
  { name: "Haddad", src: "/clientes/haddad.png", width: "150px" },
  { name: "JBFenix", src: "/clientes/JBFenix.png", width: "150px" },
];
          ...
          <div className="row align-items-center g-5">
            <div className="col-lg-4">
              ...
              <p className="text-secondary mb-0">
                ...
                organização para entregar soluções aderentes à realidade de cada empresa.
              </p>
            </div>
